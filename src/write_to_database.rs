...
// Assuming this is your WebSocket message type (adjust according to your actual WebSocket crate)
// enum Message {
//     Text(String),
//     // other variants...
// }
...
pub struct Data {
    ...
    pub nextFundingTime: Option<i64>,
...
pub async fn insert_message_into_db(
    ...
    let new_message = NewMessage {
        ...
        nextfundingtime: message_clone.data.nextFundingTime,
            ...
            match from_str::<MessageData>(text) {
                Ok(parsed_message) => {
                    ...
                    if parsed_message.topic.starts_with("tickers") {
                        ...
                        let _ = insert_message_into_db(parsed_message.clone(), &mut conn).await; // Pass &mut conn here
